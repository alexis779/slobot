...
parser = argparse.ArgumentParser(description="Run webcam capture worker 2")
...
args.worker_name = WorkerBase.WORKER_WEBCAM2
args.queue_name = FifoQueue.QUEUE_WEBCAM_CAPTURE2
