...
```
uv run python scripts/teleop/replay_recording.py --rrd-file /tmp/slobot/teleoperation/episode01.rrd --fps 30 --substeps 40 --vis-mode visual --recording-id episode01-sim
```
...
```
uv run python scripts/teleop/replay_recording.py --rrd-file /tmp/slobot/teleoperation/episode01.rrd --fps 30 --substeps 40 --vis-mode collision --recording-id episode01-sim
```
